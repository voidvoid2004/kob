                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            ...
                                            <input v-model="botadd.title" type="email" class="form-control"
                                                id="add-bot-title" placeholder="请输入Bot标题">
                                        </div>
                                        <div class="mb-3">
                                ...
                                <tr v-for="bot in bots" :key="bot.id">
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-secondary" style="margin-right: 20px;"
                                            data-bs-toggle="modal" :data-bs-target="'#add-bot-btn' + bot.id">修改</button>
                                        <button type="button" class="btn btn-danger"
                                            @click="remove_bot(bot)">删除</button>

                                        <!-- Modal -->
                                        <div class="modal fade " :id="'add-bot-btn' + bot.id" tabindex="-1">
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5">创建Bot</h1>
...
export default {
    ...
    setup() {
        ...
        const refresh_bots = () => {
            $.ajax({
                url: "http://127.0.0.1:3010/user/bot/getlist/",
                type: "get",
                headers: {
        ...
        const add_bot = () => {
            ...
            $.ajax({
                url: "http://127.0.0.1:3010/user/bot/add/",
                type: "post",
                data: {
                    title: botadd.title,
        ...
        const update_bot = (bot) => {
            ...
            $.ajax({
                url: "http://127.0.0.1:3010/user/bot/update/",
                type: "post",
                data: {
                    bot_id: bot.id,
                    title: bot.title,
                ...
                success(resp) {
                    if (resp.error_message === "success") {
                        Modal.getInstance('#add-bot-btn' + bot.id).hide();
                        refresh_bots();
                    } else {
        ...
        const remove_bot = (bot) => {
            $.ajax({
                url: "http://127.0.0.1:3010/user/bot/remove/",
                type: "post",
                data: {
                    bot_id: bot.id,
                },
